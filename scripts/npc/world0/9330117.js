...
var gachaponName = "經驗值轉蛋機";
var broadcastItem = [2370000, 2370001, 2370002, 2370003, 2370004];//抽到會廣播的物品ID
var gachaponList = 
[
	new GachaponItem(2370000, 1, 3),
	new GachaponItem(2370001, 1, 6),
	new GachaponItem(2370002, 1, 9),
	new GachaponItem(2370003, 1, 16),
	new GachaponItem(2370004, 1, 19),
	new GachaponItem(2370005, 1, 22),
	new GachaponItem(2370006, 1, 25),
	new GachaponItem(2370007, 1, 28),
	new GachaponItem(2370008, 1, 31),
	new GachaponItem(2370009, 1, 34),
	new GachaponItem(2370010, 1, 37),
	new GachaponItem(2370011, 1, 40),
	new GachaponItem(2370012, 1, 43)
];
