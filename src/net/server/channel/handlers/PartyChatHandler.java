...
public final class PartyChatHandler extends AbstractMaplePacketHandler {
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        WorldServer world = c.getWorldServer();
        if (type == 0) {
            ...
            if (allianceId > 0) {
                Server.getInstance().allianceMessage(allianceId, MaplePacketCreator.serverNotice(6, "(聯盟) " + player.getName() + " : " + chattext), player.getId(), -1);
            }
        }
