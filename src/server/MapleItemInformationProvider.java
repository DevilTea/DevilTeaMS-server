...
//        return ret;
    ...
    public void checkCashWeapon() {
        String needFix = "";
        int i = 0, j = 1701000;
        for(j = 1701000;j <= 1702693;j++) {
            MapleData data = equipData.getData("Weapon/0" + j + ".img");
            if(data != null) {
                for(MapleData datac : data.getChildren()) {
                    if(datac.getName().equals("21") || datac.getName().equals("22") || datac.getName().equals("22") || datac.getName().equals("22")
                    || datac.getName().equals("22") || datac.getName().equals("23") || datac.getName().equals("24") || datac.getName().equals("25")
                    || datac.getName().equals("26") || datac.getName().equals("36") || datac.getName().equals("52") || datac.getName().equals("53")
                    || datac.getName().equals("54") || datac.getName().equals("55") || datac.getName().equals("56") || datac.getName().equals("57")) {
                        if(i % 5 == 0) needFix += "\r\n";
                        needFix += data.getName() + ", ";
                        i++;
                        break;
                    }
                }
        ...
        if(i != 0) System.out.println(needFix);
    }
        ...
        if (data1 != null) {
            ...
            if (data2 != null) {
                for (MapleData da : data2.getChildren()) {
                    if (Math.random() < 0.9) {
                        if (da.getName().startsWith("exp")) {
                            list.add(new Pair<>("exp", MapleDataTool.getInt(da)));
                        } else if (da.getName().startsWith("incDEXMin")) {
