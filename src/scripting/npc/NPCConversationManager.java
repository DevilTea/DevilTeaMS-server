...
public class NPCConversationManager extends AbstractPlayerInteraction {
	...
	public boolean createPyramid(String mode, boolean party) {//lol
        ...
        public String get(boolean cash) {
            String list = "\r\n";
            for(Item item : getPlayer().getInventory(MapleInventoryType.EQUIPPED).list()) {
                Equip eqped = (Equip) item;
                if(!MapleItemInformationProvider.getInstance().isCash(eqped.getItemId()) || (MapleItemInformationProvider.getInstance().isCash(eqped.getItemId()) && cash))
                    list += "#L" + eqped.getPosition() + "##i" + eqped.getItemId() + "# #b#t" + eqped.getItemId() + "##l\r\n";
            }
            list += "\r\n#k";
            return list;
        }
        
        public String getEquipList(boolean cash) {
            String list = "\r\n";
        ...
        public String getUseList() {
            String list = "\r\n";
            for(Item item : getPlayer().getInventory(MapleInventoryType.USE).list()) {
                list += "#L" + item.getPosition() + "##i" + item.getItemId() + "# #b#t" + item.getItemId() + "##l\r\n";
            }
            list += "\r\n#k";
            return list;
        }
        ...
        public String getEtcList() {
            String list = "\r\n";
            for(Item item : getPlayer().getInventory(MapleInventoryType.ETC).list()) {
                list += "#L" + item.getPosition() + "##i" + item.getItemId() + "# #b#t" + item.getItemId() + "##l\r\n";
            }
            list += "\r\n#k";
            return list;
        ...
        public String getSetupList() {
            String list = "\r\n";
            for(Item item : getPlayer().getInventory(MapleInventoryType.SETUP).list()) {
                list += "#L" + item.getPosition() + "##i" + item.getItemId() + "# #b#t" + item.getItemId() + "##l\r\n";
            }
            list += "\r\n#k";
            return list;
        ...
        public String getCashList() {
            String list = "\r\n";
            for(Item item : getPlayer().getInventory(MapleInventoryType.CASH).list()) {
                list += "#L" + item.getPosition() + "##i" + item.getItemId() + "# #b#t" + item.getItemId() + "##l\r\n";
            }
            list += "\r\n#k";
            return list;
