...
public class PortalScriptManager {
    ...
    public boolean executePortalScript(MaplePortal portal, MapleClient c) {
        try {
            ...
            if (script != null) {
                if(c.getPlayer().isGM())  c.getSession().write(MaplePacketCreator.serverNotice(5, "『系統提醒』執行了Portal腳本 : " + portal.getScriptName()));
        ...
        if(c.getPlayer().isGM())  c.getSession().write(MaplePacketCreator.serverNotice(5, "『系統提醒』缺少Portal腳本 : " + portal.getScriptName()));
        return false;
    }
