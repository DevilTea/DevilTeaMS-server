...
public class AbstractPlayerInteraction {
    ...
    public List<MapleCharacter> getPartyMembers() {
            ...
            for (ChannelServer channel : Server.getInstance().getChannelsFromWorld(getPlayer().getWorld())) {
   ...
   public void openNpc(int npcid, int mode) {
          String script=npcid+"_"+mode;
            c.removeClickedNPC();
    ...
    public String getJobName(int jobid) {
        return JobName.getJobName(jobid);
    }
    ...
    public void clearSavedLocation(String type) {
        getPlayer().clearSavedLocation(type);
    }
    
    public int getSavedLocation(String type) {
        return getPlayer().getSavedLocation(type);
    }
    
    public void saveLocation(String type) {
        getPlayer().saveLocation(type);
    }
